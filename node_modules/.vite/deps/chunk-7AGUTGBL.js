...
var RefIcon = React2.forwardRef(BarsOutlined);
if (true) {
...
var RefIcon2 = React3.forwardRef(LeftOutlined);
if (true) {
...
var RefIcon3 = React4.forwardRef(RightOutlined);
if (true) {
...
var SiderContext = React5.createContext({});
...
var Sider = React5.forwardRef((props, ref) => {
  const {
  ...
  const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React5.createElement("span", {
    onClick: toggle,
  ...
  }, trigger || React5.createElement(BarsOutlined_default2, null)) : null;
  const reverseIcon = direction === "rtl" === !reverseArrow;
  const iconObj = {
    expanded: reverseIcon ? React5.createElement(RightOutlined_default2, null) : React5.createElement(LeftOutlined_default2, null),
    collapsed: reverseIcon ? React5.createElement(LeftOutlined_default2, null) : React5.createElement(RightOutlined_default2, null)
  };
  const status = collapsed ? "collapsed" : "expanded";
  const defaultTrigger = iconObj[status];
  const triggerDom = trigger !== null ? zeroWidthTrigger || React5.createElement("div", {
  ...
  return wrapCSSVar(React5.createElement(SiderContext.Provider, {
    value: contextValue
  }, React5.createElement("aside", Object.assign({
    className: siderCls
  }, divProps, {
    style: divStyle,
    ref
...
function generator({
  ...
  return (BasicComponent) => {
    const Adapter = React6.forwardRef((props, ref) => React6.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React6.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
  ...
  return wrapSSR(React6.createElement(TagName, Object.assign({
    className: (0, import_classnames2.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId, cssVarCls),
    ref
  }, others)));
});
var BasicLayout = React6.forwardRef((props, ref) => {
  const {
    direction
  } = React6.useContext(ConfigContext);
  const [siders, setSiders] = React6.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  return wrapCSSVar(React6.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React6.createElement(Tag, Object.assign({
    ref,
...
//# sourceMappingURL=chunk-7AGUTGBL.js.map
